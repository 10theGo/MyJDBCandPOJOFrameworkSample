...
public class Pojo_deserialize {
    ...
    public void oneSpartanPojo() {
        Response response = given().accept(ContentType.JSON)
                .pathParam("id", 15)
                .when().get("https://52.55.102.92:8000/api/spartans/{id}");
    ...
    public void regionToPojo(){
        Response response = when().get("http://34.229.106.124:1000/ords/hr/regions");
        ...
        System.out.println(regions.getItems().get(0)); // getting first item from list
